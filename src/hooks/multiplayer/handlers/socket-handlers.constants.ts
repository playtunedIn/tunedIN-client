...
export const EXIT_ROOM_MESSAGE = 'exitRoom';

export type WebSocketMessageTypes = typeof CREATE_ROOM_MESSAGE | typeof JOIN_ROOM_MESSAGE | typeof START_GAME_MESSAGE | typeof EXIT_ROOM_MESSAGE;
